# LangChain Node.js + AMC

A LangChain JS/TS agent that routes all LLM calls through the AMC Gateway for transparent evidence collection.
...
amc wrap langchain-node -- npx tsx index.ts
...
The adapter definition is in `src/adapters/builtins/langchainNode.ts`.
