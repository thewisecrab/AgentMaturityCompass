...
const CATEGORIES = [
  {
    ...
    icon: '🚀',
    docs: ['GETTING_STARTED', 'QUICKSTART', 'INSTALL', 'INSTALL_PACKAGES', 'AGENT_GUIDE', 'SOLO_USER', 'SOLO_DEV_QUICKSTART', 'PLATFORM_ENGINEER_QUICKSTART', 'SECURITY_COMPLIANCE_QUICKSTART', 'EXECUTIVE_OVERVIEW', 'COMPATIBILITY_MATRIX', 'STARTER_BLUEPRINTS', 'OSS_ADOPTION_ROADMAP', 'TROUBLESHOOTING']
  },
  {
    name: 'Architecture',
    icon: '🏗️',
  ...
  },
  {
    name: 'Operations',
    icon: '⚙️',
    docs: ['OPERATIONS', 'OPS_HARDENING', 'BACKUPS', 'DEPLOYMENT', 'DEPLOYMENT_CHECKLIST', 'MIGRATION_RUNBOOK', 'RELEASE_RUNBOOK', 'RELEASING', 'RELEASE_CADENCE', 'CI_TEMPLATES', 'PUBLISHING', 'UPGRADE_AUTOPILOT', 'INCIDENT_RESPONSE_READINESS', 'DRIFT_ALERTS', 'CONTINUOUS_MONITORING', 'CONTINUOUS_RECURRENCE', 'DOCTOR', 'MECHANIC_MODE', 'MECHANIC_WORKBENCH', 'CI', 'runbooks/amc-service-down', 'runbooks/evidence-corruption', 'runbooks/score-dispute']
  },
  {
    name: 'Trust & Evidence',
    icon: '🔐',
...
const ALL_DOCS = [
  ...
  'WORK_ORDERS','ZERO_KEYS','COMPATIBILITY_MATRIX','STARTER_BLUEPRINTS','OSS_ADOPTION_ROADMAP','INSTALL_PACKAGES','SUPPORT_POLICY','RELEASE_CADENCE','CI_TEMPLATES','TROUBLESHOOTING','COMMUNITY','SOLO_DEV_QUICKSTART','PLATFORM_ENGINEER_QUICKSTART','SECURITY_COMPLIANCE_QUICKSTART','HARDENING','agent-framework-compatibility','db-schemas',
