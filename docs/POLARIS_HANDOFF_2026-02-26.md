...
AMC now has **74 score modules**, **71 assurance packs**, and **118 diagnostic questions** — up from 69/66/111. All derived from 17 peer-reviewed 2026 arXiv papers on agentic AI security, governance, and trust.
...
- Question bank: 118 questions validated against schema

## What the Website Needs

The Design Council should update the AMC website (`website/index.html`) to reflect:

1. **Updated stats**: 74 score modules (was 69), 71 assurance packs (was 66), 118 diagnostic questions (was 111)
...
## Commit
`d8e6b2c` — feat: research-derived modules + docs update — 74 modules, 71 packs, 118 questions
